...
class Project(models.Model):
    ...
    with_npo = models.CharField(max_length=100, verbose_name='Номер контракта/договора с НПО машиностроения',
                                unique=True)
...
class Item(models.Model):
    ...
    item_tn_from = models.CharField(null=True, blank=True, max_length=50, verbose_name='ТН получения шасси с ОАО "МЗКТ"')
...
class Reclamacia(models.Model):
    ...
    notice_from = models.CharField(null=True, blank=True, max_length=50,
                                   verbose_name='Уведомление от НПО машиностроения')
    notice_to = models.CharField(null=True, blank=True, max_length=50, verbose_name='Уведомление на ОАО "МЗКТ"')
    recl_akt_from = models.CharField(null=True, blank=True, max_length=50,
                                     verbose_name='Рекламационный акт от НПО машиностроения')
    recl_akt_to = models.CharField(null=True, blank=True, max_length=50,
                                   verbose_name=' Рекламационный акт на ОАО "МЗКТ"')
    ai_to = models.CharField(null=True, blank=True, max_length=50,
                             verbose_name='Акт исследования на НПО машиностроения')
    ai_from = models.CharField(null=True, blank=True, max_length=50, verbose_name='Акт исследования от ОАО "МЗКТ"')
    aur_from = models.CharField(null=True, blank=True, max_length=50,
                                verbose_name='Акт удовлетворения рекламации от НПО машиностроения')
    aur_to = models.CharField(null=True, blank=True, max_length=50,
                              verbose_name='Акт удовлетворения рекламации на ОАО "МЗКТ"')
    item = models.ForeignKey(Item, on_delete=models.PROTECT)
    on_modify = models.DateTimeField(auto_now_add=True, verbose_name='Последняя дата модификации')
